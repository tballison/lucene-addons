...
public abstract class QueryParserTestBase extends LuceneTestCase {
    ...
    public Class<? extends Throwable> getParseExceptionClass() {
        return this instanceof TestQueryParser
    ...
    public static class SimpleCJKAnalyzer extends Analyzer {
        @Override
        public TokenStreamComponents createComponents(String fieldName) {
...
//        "+term +phrase1 +phrase2 +term");
    ...
    public void testRangeQueryRequiresTO() throws Exception {
        ...
        Class<? extends Throwable> exceptionClass = getParseExceptionClass();
    ...
    private double getBoost(Query q) {
...
//  }
    ...
    public static class MockCollationAnalyzer extends Analyzer {
        @Override
        public TokenStreamComponents createComponents(String fieldName) {
            Tokenizer tokenizer = new MockTokenizer(MockTokenizer.WHITESPACE, true);
    ...
    public void testParserSpecificSyntax() throws Exception {
        ...
        expectThrows(getParseExceptionClass(), () -> getQuery("[A B]"));
        expectThrows(getParseExceptionClass(), () -> getQuery("[TO B]"));
        expectThrows(getParseExceptionClass(), () -> getQuery("[A TO]"));
